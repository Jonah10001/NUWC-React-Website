				...
				<div className="container" id="footerfix">
					<div class='page-wrap'>
						<section class='contact-content'>
							...
							<p>Prabav Jain</p>
							<small> <a href="mailto: PrabavJain2023@u.northwestern.edu" target="_blank">PrabavJain2023@u.northwestern.edu</a></small>
						</section>
						<section class='contact-content'>
							<h1>Vice President</h1>
							<img src={vp} class = 'profilepic' alt = "Carson Burton"/>
							<p>Abraham Cruz</p>
							<small> <a href="mailto: AbrahamCruz2023@u.northwestern.edu" target="_blank">AbrahamCruz2023@u.northwestern.edu</a></small>
						</section>
						<section class='contact-content'>
							<h1>Treasurer</h1>
							<img src={sec} class = 'profilepic' alt = "Chase Moralejo"/>
							<p>Josh Linero</p>
							<small> <a href="mailto: JoshLinero2024@u.northwestern.edu" target="_blank">JoshLinero2024@u.northwestern.edu</a></small>
						</section>
						<br /> <br />
					</div>
